...
export class APIUtils
{
    ...
    constructor(apiContext:APIRequestContext, loginPayLoad:any) //this apiContext is created in the beforeAll hook of the test file and passed to the constructor of this class when creating an object of this class in the beforeAll hook of the test file
    {
